...
func TestRedisUserStatusOperations() {
	fmt.Println("=== Testing Redis User Status Operations ===")
	...
	// Run test cases
	testUserStatusOperations(userStatusRepo)
}

func testUserStatusOperations(repo domain.UserStatusRepository) {
